...
<layouts:admin pageTitle="Landing Page">
	<jsp:attribute name="pageContent">
		<div><h1>Prodotti </h1><p><a href="#">Nuovo prodotto <i class="fas fa-plus-circle"></i></a></p></div>
		<form>
			<div class="col-auto">
				<label class="sr-only" for="inlineFormInputGroup">Cerca</label>
				<div class="input-group mb-2">
					<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Cerca">
