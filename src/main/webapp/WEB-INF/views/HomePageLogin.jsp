							...
							<div class="card">
								<div class="card-body">
									...
									<div class="p-1 pt-3 pb-2 autocomplete" v-show="showAutocomplete">
										...
										<li v-if="showAutocompleteList" class="pointer autocomplete-li" v-bind:class="{ selected: autocompleteComputed[index].selected }" v-for='(item, index) in autocompleteComputed' v-bind:key='item.name' @click="replaceQuerySearch(item.name)">{{ item.name }}</li>
									</div>
