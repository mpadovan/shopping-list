...
<layouts:empty pageTitle="Landing Page Anonimus">
	<jsp:attribute name="pageContent">
		<div class="fullpage-outer" id="app">
			<div class="section">
				<div class="centered">
					<div class="intro_top_home">
						<h1 style="font-size: 5rem" class="font-weight-bold">PLACEHOLDER</h1>
					</div>
				</div>
			</div>
				...
				<transition name="fade">
					<div class="centered">
						<div class="row justify-content-center" v-show="loaded_list" style="display: none;">
							<div class="col-md-10 mt-4 align-self-center">
								<div class="card">
									<div class="card-body">
		...
		<div class="section cat-res"> 
			<transition name="fade">
				<div class="centered">
					<div class="row justify-content-center">
						<div class="col-md-9 card" style="border:0px; padding:0px; max-height:70vh;"> 
