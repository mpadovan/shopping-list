...
<nav id="sidebar" style="overflow-y: scroll;">
    ...
    <div class="sidebar-body">
		<div>
			<a href="${pageContext.servletContext.contextPath}/restricted/ProductList/${sessionScope.user.hash}"><p  class="font-weight-bold p-products-sidebar">I tuoi prodotti</p></a>
