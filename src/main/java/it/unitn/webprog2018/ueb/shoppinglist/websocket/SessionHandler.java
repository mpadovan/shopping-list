...
/**
 * Abstract class that implements the common methods for {@link it.unitn.webprog2018.ueb.shoppinglist.websocket.chat.ChatSessionHandler}
 * and {@link it.unitn.webprog2018.ueb.shoppinglist.websocket.notification.NotificationSessionHandler}.
...
public abstract class SessionHandler {
	 ...
	 * Should be set once and for all at application startup (in a ServletContextListener).
	 * 
	 ...
	 * 
	 * @param userId Unique identifier of the {@link it.unitn.webprog2018.ueb.shoppinglist.entities.User}
	...
	*/
	...
	/**
	 * Removes the session of the user from the ones managed by the session handler.
	 * 
	 * @param userId Unique identifier of the {@link it.unitn.webprog2018.ueb.shoppinglist.entities.User}
	 */
